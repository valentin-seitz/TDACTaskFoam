...
#include "TDACTaskChemistryModel.H"
...
Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::TDACTaskChemistryModel
(
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    scalarField& dcdt
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
...
Foam::scalar Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::solve
(
...
template<class ReactionThermo, class ThermoType>
void Foam::TDACTaskChemistryModel<ReactionThermo, ThermoType>::
