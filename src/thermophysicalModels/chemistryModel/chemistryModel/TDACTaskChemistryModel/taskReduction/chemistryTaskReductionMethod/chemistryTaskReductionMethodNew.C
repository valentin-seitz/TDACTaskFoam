...
Foam::autoPtr<Foam::chemistryTaskReductionMethod<CompType, ThermoType>>
Foam::chemistryTaskReductionMethod<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryTaskReductionMethod<CompType, ThermoType>>
    (
