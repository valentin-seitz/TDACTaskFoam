...
#include "chemistryTaskReductionMethod.H"
#include "TDACTaskChemistryModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CompType, class ThermoType>
Foam::chemistryTaskReductionMethod<CompType, ThermoType>::chemistryTaskReductionMethod
(
    const Foam::IOdictionary& dict,
    Foam::TDACTaskChemistryModel<CompType, ThermoType>& chemistry
)
:
    dict_(dict),
...
template<class CompType, class ThermoType>
Foam::chemistryTaskReductionMethod<CompType, ThermoType>::
