...
Foam::scalar Foam::chemPointTaskISAT<CompType, ThermoType>::tolerance_;

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::qrDecompose
(
    const label nCols,
...
template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::qrUpdate
(
    scalarSquareMatrix& R,
    const label n,
...
template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::rotate
(
    scalarSquareMatrix& R,
    const label i,
    const scalar a,
...
template<class CompType, class ThermoType>
Foam::chemPointTaskISAT<CompType, ThermoType>::chemPointTaskISAT
(
    ...
    binaryTaskNode<CompType, ThermoType>* node
)
:
...
Foam::chemPointTaskISAT<CompType, ThermoType>::chemPointTaskISAT
(
    Foam::chemPointTaskISAT<CompType, ThermoType>& p
)
:
...
template<class CompType, class ThermoType>
bool Foam::chemPointTaskISAT<CompType, ThermoType>::inEOA(const scalarField& phiq)
{
...
template<class CompType, class ThermoType>
bool Foam::chemPointTaskISAT<CompType, ThermoType>::checkSolution
(
...
template<class CompType, class ThermoType>
bool Foam::chemPointTaskISAT<CompType, ThermoType>::grow(const scalarField& phiq)
{
    scalarField dphi(phiq - phi());
...
template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::increaseNumRetrieve()
{
    this->numRetrieve_++;
}
...
template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::resetNumRetrieve()
{
    this->numRetrieve_ = 0;
}
...
template<class CompType, class ThermoType>
void Foam::chemPointTaskISAT<CompType, ThermoType>::increaseNLifeTime()
{
    this->nLifeTime_++;
}
...
template<class CompType, class ThermoType>
Foam::label Foam::chemPointTaskISAT<CompType, ThermoType>::
