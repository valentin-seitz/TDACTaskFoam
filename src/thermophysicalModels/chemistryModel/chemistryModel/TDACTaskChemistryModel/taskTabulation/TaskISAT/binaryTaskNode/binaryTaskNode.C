...
#include "binaryTaskNode.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CompType, class ThermoType>
Foam::binaryTaskNode<CompType, ThermoType>::binaryTaskNode()
:
    leafLeft_(nullptr),
    leafRight_(nullptr),
    nodeLeft_(nullptr),
...
Foam::binaryTaskNode<CompType, ThermoType>::binaryTaskNode
(
    chemPointTaskISAT<CompType, ThermoType>* elementLeft,
    chemPointTaskISAT<CompType, ThermoType>* elementRight,
    binaryTaskNode<CompType, ThermoType>* parent
)
:
...
template<class CompType, class ThermoType>
void Foam::binaryTaskNode<CompType, ThermoType>::calcV
(
    chemPointTaskISAT<CompType, ThermoType>*& elementLeft,
    chemPointTaskISAT<CompType, ThermoType>*& elementRight,
    scalarField& v
...
template<class CompType, class ThermoType>
Foam::scalar Foam::binaryTaskNode<CompType, ThermoType>::calcA
(
    chemPointTaskISAT<CompType, ThermoType>* elementLeft,
    chemPointTaskISAT<CompType, ThermoType>* elementRight
)
