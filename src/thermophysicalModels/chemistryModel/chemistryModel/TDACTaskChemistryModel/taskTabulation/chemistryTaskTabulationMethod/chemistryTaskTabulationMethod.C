...
#include "chemistryTaskTabulationMethod.H"
#include "TDACTaskChemistryModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CompType, class ThermoType>
Foam::chemistryTaskTabulationMethod<CompType, ThermoType>::chemistryTaskTabulationMethod
(
...
template<class CompType, class ThermoType>
Foam::chemistryTaskTabulationMethod<CompType, ThermoType>::
~chemistryTaskTabulationMethod()
{}
