...
Foam::autoPtr<Foam::chemistryTaskTabulationMethod<CompType, ThermoType>>
Foam::chemistryTaskTabulationMethod<CompType, ThermoType>::New
(
...
)
{
    ...
    return autoPtr<chemistryTaskTabulationMethod<CompType, ThermoType>>
    (
